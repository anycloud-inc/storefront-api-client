import { ApiClient, Headers, CustomFetchApi, ApiClientLogger, ApiClientLogContentTypes } from "@shopify/graphql-client";
...
export type StorefrontApiClient = ApiClient<Readonly<StorefrontApiClientConfig>>;
